...
import { Upload, Plus, Trash2, ArrowLeft, X, Users, Rocket } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        {/* For Sale - DISABLED FOR NOW */}
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between p-3.5 rounded-lg border bg-slate-50 border-slate-200 opacity-60">
            <div className="flex flex-col gap-0.5">
        ...
        {/* Advertise Section */}
        <div className="mt-4 p-5 rounded-xl border-2 border-dashed border-blue-200 bg-blue-50/50">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 bg-blue-100 rounded-lg">
              <Rocket size={18} className="text-blue-600" />
            </div>
            <h3 className="text-base font-bold text-slate-800">Advertise your SaaS</h3>
          </div>
